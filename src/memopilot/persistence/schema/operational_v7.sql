CREATE TABLE scheduled_executions_v7 (
...
INSERT INTO scheduled_executions_v7(
    execution_id, task_id, scheduled_at, state, created_at, updated_at
)
SELECT execution_id, task_id, scheduled_at, state, created_at, updated_at
FROM scheduled_executions;

DROP TABLE scheduled_executions;
ALTER TABLE scheduled_executions_v7 RENAME TO scheduled_executions;

DROP TABLE turn_interrupt_snapshots;
DROP TABLE session_interrupts;
DROP TABLE steps;
